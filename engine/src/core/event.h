 ...
 * @returns TRUE if the event is sucesfully registered; otherwise false.
 */
 ...
 * @param listener A pointer to a listener instance. Can be 0/NULL.
 * @param on_event The callback function pointer to be invoked when the event code is fired.
 * @returns TRUE if the event is sucesfully unregistered; otherwise false.
 */
 ...
 * @param code The event code to listen for.
 * @param listener A pointer to a listener instance. Can be 0/NULL.
 * @param context The event context data.
 * @returns TRUE if event marked as handled; otherwise false.
 */
CAPI b8 event_fire(u16 code, void* listener, event_context context);
